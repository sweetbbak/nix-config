...
# THANKS github.com/wochap/nix-config - nix-config/packages/scenefx
stdenv.mkDerivation rec {
  ...
  patches = [
    (fetchurl {
      ...
      url = "https://github.com/wlrfx/scenefx/commit/640e92102b9043fdd840004b85be5aa7e1fddfa9.patch";
